...
const FAQ = () => {
  ...
  const faqs = language === 'ar' ? [
      ...
      questions: [
        {
          ...
          answer: 'تحتاج إلى: (1) رخصة قيادة سارية المفعول، (2) بطاقة هوية وطنية أو جواز سفر. للسياح الأجانب: رخصة قيادة دولية وجواز سفر.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        {
          question: 'هل يمكنني القيادة خارج عمان؟',
          answer: 'نعم، يمكنك القيادة إلى محافظات الاردن جميعها (عجلون , جرش , معان,الكرك,السلط و جميع المحافظات ). يرجى إبلاغنا عند الحجز.'
        },
        {
          question: 'هل هناك حد أقصى للكيلومترات؟',
          answer: 'معظم حجوزاتنا تأتي بكيلومترات غير محدودة .'
        },
        {
          question: 'هل يمكن لشخص آخر قيادة السيارة؟',
          answer: 'نعم، يمكن إضافة سائق إضافي بتكلفة 5 دنانير أردنية مرة واحده فقط. يجب أن يكون السائق الإضافي مذكوراً في العقد ويستوفي نفس شروط التأجير.'
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'بالتأكيد! نوفر فواتير لجميع المعاملات. يمكنك طلبها عند التسليم أو إرسالها عبر البريد الإلكتروني.'
        }
      ]
    }
  ] : [
